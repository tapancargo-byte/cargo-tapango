try {
  (() => {
    ...
    var Q = se(($, K) => {
      ...
      f();
      (function (e) {
        if (typeof $ == 'object' && typeof K < 'u') K.exports = e();
        ...
        return (function r(i, d, l) {
          ...
          for (var n = typeof T == 'function' && T, I = 0; I < l.length; I++)
            t(l[I]);
          return t;
        })(
          {
              ...
              function (r, i, d) {
                ...
                i.exports = function (c) {
                  ...
                  return function (S) {
                    var m = function () {
                      ...
                      for (O = 0; O < E; O++) {
                        if (
                          ((P[O] = { cacheItem: b, arg: arguments[O] }),
                          b.has(arguments[O]))
                        ) {
                          b = b.get(arguments[O]);
                          continue;
                      ...
                      return (
                        ...
                        A ||
                          ...
                          b.set(arguments[E], R)),
                        c > 0 &&
                          ((P[E] = { cacheItem: b, arg: arguments[E] }),
                          A ? t(s, P) : s.push(P),
                          s.length > c && n(s.shift())),
                        (m.wasMemoized = A),
                        (m.numArgs = E + 1),
                        R
                      );
                ...
                function n(c) {
                  var u = c.length,
                    ...
                    m;
                  for (
                    s.cacheItem.delete(s.arg), m = u - 2;
                    m >= 0 &&
                    ((s = c[m]), (S = s.cacheItem.get(s.arg)), !S || !S.size);
                    m--
                  )
        ...
        return I
          ? t.concat(
              I.map(function (c) {
                var u, s;
                return (s =
                  (u = c.match(/[\t ]/g)) === null || u === void 0
                    ? void 0
                    : u.length) !== null && s !== void 0
                  ? s
                  : 0;
              })
            )
