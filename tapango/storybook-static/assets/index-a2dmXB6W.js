import { c as kn } from './index-D_zSVikN.js';
var Je = { exports: {} };
(function (n, a) {
  (function (o, i) {
    i(a);
    ...
    function N(e) {
      return (t) => {
        ...
        const r = t[e.length];
        return r !== void 0 && P.test(r) ? null : { type: e, text: e };
      };
    }
    const oe = (e) => {
        const t = h(e);
    ...
    function se(e) {
      return e.type === 'JsdocTypeKeyValue' ? Q(e) : v(e);
    }
    function Dt(e) {
    ...
    class V {
      ...
      parseType(t) {
        return v(this.parseIntermediateType(t));
      }
        ...
        parsePrefix: (e) => {
          ...
          return t.type === 'JsdocTypeParameterList'
            ...
            : t.type === 'JsdocTypeKeyValue'
              ...
              : { type: 'JsdocTypeParenthesis', element: v(t) };
        },
      }),
      Ct = J({
    ...
    const Wt = J({
        ...
        parseInfix: (e, t) => {
          ...
          return Object.assign(
            Object.assign(
              { type: 'JsdocTypeGeneric', left: v(t), elements: s },
              c ? { infer: !0 } : {}
            ),
      ...
      Xt = J({
        ...
        parseInfix: (e, t) => {
          ...
          while (e.consume('|'));
          return { type: 'JsdocTypeUnion', elements: [v(t), ...r] };
        },
      }),
    ...
    function Z({
      ...
      return function (c, y, T) {
        ...
        return { type: 'JsdocTypeNamePath', left: v(T), right: B, pathType: S };
      };
    }
    ...
    function ee({ pathGrammar: e, allowedTypes: t }) {
      return J({
        ...
        parsePrefix: (r) => {
          ...
          return r.acceptLexerState(T), v(g);
        },
      });
    }
    const Re = [
      ...
      return J({
        ...
        parseInfix: (c, y) => {
          ...
          if (
            ...
            return (
              c.acceptLexerState(k),
              { type: 'JsdocTypeJsdocObjectField', left: v(y), right: S }
            );
          }
        },
      });
        ...
        parsePrefix: (e) => {
          ...
          return e.consume('is')
            ? {
                ...
                left: t,
                right: v(e.parseIntermediateType(m.INFIX)),
              }
    ...
    const nn = J({
        ...
        parsePrefix: (e) => (
          e.consume('keyof'),
          { type: 'JsdocTypeKeyof', element: v(e.parseType(m.KEY_OF_TYPE_OF)) }
        ),
      }),
      rn = J({
        name: 'importParslet',
      ...
      cn = J({
        ...
        parseInfix: (e, t) => {
          ...
          while (e.consume('&'));
          return { type: 'JsdocTypeIntersection', elements: [v(t), ...r] };
        },
      }),
      ln = J({
...
`
    ...
    const gn = {
      ...
      JsdocTypeParenthesis: (e, t) => t(v(e.element)),
    ...
    switch ((typeof o < 'u' && (u.raw = o), a)) {
      ...
      default: {
        if ((a == null ? void 0 : a.indexOf('|')) > 0)
          try {
            let E = a.split('|').map((P) => JSON.parse(P));
...
function Ge(n, a) {
  return ve(n) ? n.__docgenInfo[a] : null;
}
l(Ge, 'getDocgenSection');
function We(n) {
  return ve(n) ? $n(n.__docgenInfo.description) : '';
}
...
function ot(n = 'compact') {
  ...
  return (o) => {
    ...
    for (let [f, { tokens: h }] of o.source.entries()) {
      ...
      for (let P of h.description)
        if ((P === '{' && i++, P === '}' && i--, (E += P), i === 0)) break;
    ...
    for (let [f, [h, E]] of p.entries())
      (h.type = E),
        f > 0 &&
          ((h.type = h.postDelimiter.slice(d) + E),
...
function it() {
  ...
  return (a) => {
    ...
    if (d[0] === '[' && d[d.length - 1] === ']') {
      ...
      if (
        ((d = P[0].trim()),
        P[1] !== void 0 && (h = P.slice(1).join('=').trim()),
        d === '')
      )
        return (
          a.problems.push({
  ...
  return function (E) {
    ...
    for (let ae of He(E)) {
      ...
      P.push({
        ...
        tags: X,
        source: $,
        problems: X.reduce((N, oe) => N.concat(oe.problems), []),
      });
    }
    return P;
  };
...
l(Jt, 'extractParam');
function gt(n) {
  return n.name ? Ne(n.name, n.description) : null;
}
...
l(Ne, 'joinNameAndDescription');
function be(n) {
  let a = n.replace(/^- /g, '').trim();
  return a === '' ? null : a;
}
l(be, 'normaliseDescription');
function wt(n) {
  let a = Ee(n.type);
  return a
    ? {
        type: a,
        description: Ne(n.name, n.description),
...
l(vt, 'isTooLongForDefaultValueSummary');
function b(n, a) {
...
function Pt(n, a) {
  if (n != null) {
    let { value: o } = n;
    if (!re(o)) return vt(o) ? b(a == null ? void 0 : a.name, o) : b(o);
  }
  return null;
}
l(Pt, 'createDefaultValue');
function Se({ name: n, value: a, elements: o, raw: i }) {
  return a ?? (o != null ? o.map(Se).join(' | ') : (i ?? n));
}
l(Se, 'generateUnionElement');
function Nt({ name: n, raw: a, elements: o }) {
  return o != null
    ? b(o.map(Se).join(' | '))
    : a != null
      ? b(a.replace(/^\|\s*/, ''))
...
l(Nt, 'generateUnion');
function bt({ type: n, raw: a }) {
  return a != null ? b(a) : b(n);
}
l(bt, 'generateFuncSignature');
function Et({ type: n, raw: a }) {
  return a != null ? (xe(a) ? b(n, a) : b(a)) : b(n);
}
l(Et, 'generateObjectSignature');
function kt(n) {
  let { type: a } = n;
  return a === 'object' ? Et(n) : bt(n);
}
