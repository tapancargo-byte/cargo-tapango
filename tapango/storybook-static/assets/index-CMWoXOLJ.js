...
import { r as a } from './index-D_zSVikN.js';
var Se = [
    'hrefAttrs',
    'numberOfLines',
    'onClick',
  ...
  ce = Object.assign({}, ne, re, ae, le, se, ie, de, ue, {
    href: !0,
    lang: !0,
    pointerEvents: !0,
  }),
  ...
  pe = a.forwardRef((e, C) => {
    ...
    var B = a.useCallback(
        (c) => {
          s != null ? s(c) : r != null && (c.stopPropagation(), r(c));
        },
        [s, r]
      ),
      p = i ? 'span' : 'div',
      N = e.lang != null ? X(e.lang) : null,
      d = e.dir || N,
      F = d || z,
      o = Re(G);
    if (
      ...
      (s || r) && (o.onClick = B),
      (o.style = [
        n != null && n > 1 && { WebkitLineClamp: n },
        i === !0 ? t.textHasAncestor$raw : t.text$raw,
        n === 1 && t.textOneLine,
        n != null && n > 1 && t.textMultiLine,
        e.style,
        R === !0 && t.selectable,
        R === !1 && t.notSelectable,
        r && t.pressable,
      ]),
      e.href != null && ((p = 'a'), l != null))
    ) {
      var h = l.download,
        f = l.rel,
        u = l.target;
      h != null && (o.download = h),
        f != null && (o.rel = f),
        typeof u == 'string' && (o.target = u.charAt(0) !== '_' ? '_' + u : u);
    }
    var I = ee(o),
      J = oe(S, I, C);
    o.ref = J;
    var v = te(p, o, { writingDirection: F });
    return i ? v : a.createElement(x.Provider, { value: !0 }, v);
  });
pe.displayName = 'Text';
var m = {
