...
import { R as y } from './index-D_zSVikN.js';
import { a as W, u as B, P as V } from './ThemeProvider-CPKCwPQ2.js';
import { f as Y } from './AuthInput-cxwUew5-.js';
import { Y as U } from './Stacks-CaMMwnuE.js';
import { T as $ } from './Text-DBu9YOJb.js';
import { A as u, E as x } from './tamagui.config-DUnZTQxR.js';
...
const h = ({ text: t, tone: c = 'info' }) => {
  const e = W(),
    n = B(),
    o = {
      info: { bg: '#E3F2FD', fg: e.info || e.primary },
      success: { bg: '#E8F5E9', fg: e.success },
      warning: { bg: '#FFF4E5', fg: e.warning },
      error: { bg: '#FFEBEE', fg: e.error },
    },
    f = {
      info: { bg: 'rgba(79,195,247,0.18)', fg: e.info || e.primary },
      success: { bg: 'rgba(78,205,196,0.20)', fg: e.success },
      warning: { bg: 'rgba(255,217,61,0.22)', fg: e.warning },
      error: { bg: 'rgba(255,107,107,0.22)', fg: e.error },
    },
    p = (a) => {
      if (a.startsWith('#')) {
        const i = a.replace('#', ''),
          d = parseInt(i.substring(0, 2), 16),
          l = parseInt(i.substring(2, 4), 16),
          m = parseInt(i.substring(4, 6), 16);
        return { r: d, g: l, b: m };
      }
      const s = /rgba?\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)/.exec(a);
      if (s) {
        const [, i, d, l] = s,
          m = i ? +i : 0,
          N = d ? +d : 0,
    ...
    w = ({ r: a, g: s, b: i }) => 0.2126 * g(a) + 0.7152 * g(s) + 0.0722 * g(i),
    O = (a, s) => {
      const i = w(p(a)),
        d = w(p(s)),
        l = Math.max(i, d),
        m = Math.min(i, d);
      return (l + 0.05) / (m + 0.05);
    },
    S = (n ? f : o)[c],
    D = S.fg,
    q = e.text,
...
const T = ({ status: t, delayMs: c = 0 }) => {
    const e = y.useRef(new u.Value(0)).current,
      n = y.useRef(new u.Value(0.95)).current;
    y.useEffect(() => {
      e.setValue(0), n.setValue(0.95);
      const f = V.OS !== 'web',
        p = () =>
          u
            .parallel([
    ...
    return (
      t === 'in-transit'
        ? (o = r.jsx(h, { text: b('inTransit'), tone: 'info' }))
        : t === 'delivered'
          ? (o = r.jsx(h, { text: b('delivered'), tone: 'success' }))
          : t === 'delayed'
            ? (o = r.jsx(h, { text: b('delayed'), tone: 'error' }))
            : (o = r.jsx(h, { text: b('onSchedule'), tone: 'warning' })),
      r.jsx(u.View, {
        style: { opacity: e, transform: [{ scale: n }] },
        children: o,
      })
    );
  },
  le = {
    ...
    args: { status: 'in-transit' },
  },
  v = {
    render: (t) =>
      r.jsx('div', {
        'data-testid': 'statuspill-playground',
        children: r.jsx(T, { ...t }),
      }),
  },
  k = {
      ...
      r.jsx('div', {
        ...
        children: [
          ...
          r.jsx(
            'div',
            {
              'data-testid': `statuspill-${t}`,
              children: r.jsx(T, { status: t }),
            },
            t
          )
        ),
...
v.parameters = {
  ...v.parameters,
  docs: {
    ...((A = v.parameters) == null ? void 0 : A.docs),
    source: {
      originalSource: `{
  render: args => <div data-testid="statuspill-playground">\r
      <StatusPill {...args} />\r
    </div>
}`,
      ...((C = (R = v.parameters) == null ? void 0 : R.docs) == null
        ? void 0
        : C.source),
    },
  },
...
k.parameters = {
  ...k.parameters,
  docs: {
    ...((E = k.parameters) == null ? void 0 : E.docs),
    source: {
      originalSource: `{
  render: () => <div style={{
    display: 'flex',
    ...
    alignItems: 'center'
      ...
      {['pending', 'confirmed', 'in-transit', 'delivered', 'cancelled', 'delayed'].map(s => <div key={s} data-testid={\`statuspill-\${s}\`}><StatusPill status={s as any} /></div>)}\r
    </div>
}`,
      ...((F = (I = k.parameters) == null ? void 0 : I.docs) == null
        ? void 0
        : F.source),
    },
  },
};
const ue = ['Playground', 'AllStatuses'];
export {
  k as AllStatuses,
  v as Playground,
