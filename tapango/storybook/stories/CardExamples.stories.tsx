      ...
      <div style={{ display: 'grid', gap: 16, maxWidth: 420, color: t.colors.text }}>
        <ElevatedCard mode={globals.mode}>
          <div style={{ display: 'grid', gap: 8 }}>
            ...
            <span data-testid="example-elevated-body">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</span>
        ...
        <GlassCard mode={globals.mode}>
          <div style={{ display: 'grid', gap: 8 }}>
            ...
            <span data-testid="example-glass-body">Frosted glass visual with translucent background.</span>
            <button style={{ padding: 8 }}>Action</button>
          </div>
        </GlassCard>
      </div>
