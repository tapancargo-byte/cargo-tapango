...
export const Welcome: StoryObj = {
  render: () => (
    <div style={{ height: 640, display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #0D47A1 0%, #42A5F5 100%)' }}>
      <YStack alignItems="center" space="$3">
        <Body color="#FFFFFF" align="center">Northeast India's Premier Cargo Network</Body>
        <Display color="#FFFFFF" align="center" weight="bold">Welcome to TAPANGO</Display>
