...
export interface InputProps extends Omit<TextInputProps, 'style' | 'onChangeText' | 'value' | 'placeholder' | 'secureTextEntry' | 'keyboardType'> {
  label?: string
  value?: string
  placeholder?: string
...
export const Input: React.FC<InputProps> = ({
  ...
  const isDark = (() => { try { return useIsDark() } catch { return mode === 'dark' } })()
  ...
  return (
    <YStack space="$1">
      ...
      <XStack alignItems="center" borderRadius={12} paddingHorizontal="$3" backgroundColor={bg} borderWidth={borderWidth} borderColor={borderColor} style={style as any}>
